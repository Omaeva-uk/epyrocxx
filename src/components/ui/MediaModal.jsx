  ...
  return (
    <>
      <MotionConfig transition={transition}>
        <>
          <motion.div
            className="w-full h-full flex relative  flex-col overflow-hidden border cursor-pointer dark:bg-black bg-gray-300 hover:bg-gray-200 dark:hover:bg-gray-950"
        ...
        <AnimatePresence initial={false} mode="sync">
          {isMediaModalOpen && (
            <>
              ...
              >
                <motion.div
                  className="pointer-events-auto relative flex flex-col overflow-hidden   dark:bg-gray-950 bg-gray-200 border w-[80%] h-[80%] top-12 "
                  layoutId={`dialog-${uniqueId}`}
                  tabIndex={-1}
                  style={{
                    borderRadius: '24px',
